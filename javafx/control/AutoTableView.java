 ...
 * 
 * Dans cette classe, il est important que l'utilisateur passe les �l�ments du tableau dans le contructeur
 * et n'appelle la m�thode setItems que si les �l�ments ne seront pas soumis � un filtre
 * Si cela se produit, le m�canisme de filtrage mis en place ne sera plus utilisable 
 * et l'utilisateur devra s'en occuper lui-m�me ext�rieurement
 * 
 * Pour ajouter un �l�ment � la liste, utiliser plut�t la fonction getActualList instead
 * 
 * @author VPOREL-DEV
 *
 * @param <Entity>
...
public class AutoTableView<Entity> extends TableView<Entity>{
	 ...
	 * Le graphic(icon) est g�n�r� � partir de la librairie Ikonli
	 * @param eventName
	...
	public static class ButtonActionEvent extends Event{
		...
		/**
		 * Propri�t� sp�cifique permettant de savoir quel bouton a d�clench� l'�v�nement sur la liste
		 */
		private String name;
