...
public abstract class Form<Entity> {
	...
	public Form(Entity object) throws NullFormObjectException {
		if(object != null)
			...
			throw new NullFormObjectException("L'object pass� au constructeur du formulaire est null.");
    ...
    /**
     * Peut �tre appel�e pour hydrater l'objet en param�tre en lui passant les donn�es (aussi en param�tre)
     * @param objectData
     * @param obj
     */
